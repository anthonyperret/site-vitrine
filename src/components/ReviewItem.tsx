...
export default function ReviewItem({ review, i }: Props) {
  ...
  return (
    ...
    <div
      ...
      className={`flex-1 cursor-pointer bg-fonderie text-ivoire lg:px-10 lg:py-10 px-5 py-5 flex flex-col lg:gap-5 gap-1 border-t-3 border-transparent hover:border-cuivre hover:bg-fonderie/80 transition-colors ${visible ? "animate-fade-up" : "opacity-0"}`}
