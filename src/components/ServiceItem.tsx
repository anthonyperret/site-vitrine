  ...
  return(
    <Link href={`/services#${service.number}`} className="flex-1">
      <div
        ...
        className={`h-full cursor-pointer bg-fonderie text-ivoire lg:px-10 lg:py-10 px-5 py-5 flex flex-col lg:gap-5 gap-3 border-t-3 border-transparent hover:border-cuivre hover:bg-fonderie/80 transition-colors ${visible ? "animate-fade-up" : "opacity-0"}`}
