...
export default function ServiceCard({ service }: Props) {
  ...
  return(
    ...
    >
      ...
      {/* Desktop */}
      <div className={`bg-acier border-r w-1/3 px-10 py-10 border-ivoire/33 lg:flex hidden flex-col justify-between`}>
        <div className="flex flex-col gap-2">
          <h3 className="text-ivoire font-bebas-neue text-4xl">
            {service.title}
      ...
      {/* Mobile */}
      <div className={`bg-acier border-b px-5 py-3 border-ivoire/33 lg:hidden flex`}>
        <div className="flex flex-col gap-2">
          <div className="flex gap-3">
            <h3 className="text-ivoire">
              {service.title}
              <span className="accent">{service.titleAccent}</span>
            </h3>
          </div>
