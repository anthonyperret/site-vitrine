...
export default function MentionsLegales() {
  ...
  return (
    <div>
        ...
        <Section bg="fonderie" title="Mentions" highlight="légales.">
            <div className="w-full lg:mt-15 mt-10 text-ivoire font-dm-sans">
        ...
        <div id="politique-de-confidentialite" className="scroll-mt-10"></div>
        <Section bg="acier" title="Politique de" highlight="confidentialité.">
            <div  className="w-full lg:mt-15 mt-10 text-ivoire font-dm-sans">
                ...
                <h3 className="mb-3">Finalités et base légale</h3>
                <p>Vos données sont utilisées pour deux finalités :</p>
                <ul className="ml-5">
                    <li className="list-disc text-xs lg:text-sm">Traiter votre demande de devis et vous apporter une réponse (base légale : mesures précontractuelles, art. 6.1.b du RGPD).</li>
                    <li className="list-disc text-xs lg:text-sm">Vous adresser ultérieurement des communications commerciales sur les services de Farga (base légale : intérêt légitime, art. 6.1.f du RGPD).</li>
                </ul>
